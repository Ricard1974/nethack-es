...
Fread(genericptr_t ptr, int size, int nitems, dlb *stream)
{
    ...
    if ((cnt = dlb_fread(ptr, size, nitems, stream)) != nitems) {
        panic(
  _("Premature EOF on dungeon description file!\r\nExpected %d bytes - got %d."),
