...
start: plain
	Description: igual que los simbolos por defecto, excepto '+' para las esquinas de muro
	S_tlcorn: '+'
	S_trcorn: '+'
	S_blcorn: '+'
	S_brcorn: '+'
	...
	S_tlwall: '+'
	S_trwall: '+'
finish #plain -- los demas simbolos conservan implicitamente sus valores por defecto

# All symbols are spaces
start: Blank
	Description: simbolos completamente en blanco
        S_air: \032
        S_altar: \032
        S_amulet: \032
        S_angel: \032
...
start: IBMgraphics
	Description: caracteres especiales de dibujo de lineas usados para muros
#	Restrictions: primary
	Handling: IBM
	S_vwall: \xb3			# meta-3, barra vertical
	S_hwall: \xc4			# meta-D, barra horizontal
	S_tlcorn: \xda			# meta-Z, esquina superior izquierda
	S_trcorn: \xbf			# meta-?, esquina superior derecha
	S_blcorn: \xc0			# meta-@, esquina inferior izquierda
	S_brcorn: \xd9			# meta-Y, esquina inferior derecha
	S_crwall: \xc5			# meta-E, cruz
	S_tuwall: \xc1			# meta-A, T hacia arriba
	S_tdwall: \xc2			# meta-B, T hacia abajo
	S_tlwall: \xb4			# meta-4, T hacia la izquierda
	S_trwall: \xc3			# meta-C, T hacia la derecha
	S_ndoor: \xfa			# meta-z, punto centrado
	S_vodoor: \xfe			# meta-~, cuadrado pequeno centrado
	S_hodoor: \xfe			# meta-~, cuadrado pequeno centrado
	S_engroom: \xee                 # epsilon
	S_bars: \xf0			# simbolo de equivalencia
	S_tree: \xf1			# simbolo mas o menos
	S_room: \xfa			# meta-z, punto centrado
	S_corr: \xb0			# meta-0, sombreado claro
	S_litcorr: \xb1			# meta-1, sombreado medio
	S_engrcorr: \xb0		# meta-0, sombreado claro
	S_fountain: \xf4		# meta-t, mitad superior de integral
	S_sink: \xf4			# meta-t, mitad superior de integral
	S_pool: \xf7			# meta-w, aproximadamente igual
	S_ice: \xfa			# meta-z, punto centrado
	S_lava: \xf7			# meta-w, aproximadamente igual
	S_lavawall: \xf7		# meta-w, aproximadamente igual
	S_vodbridge: \xfa		# meta-z, punto centrado
	S_hodbridge: \xfa		# meta-z, punto centrado
	S_water: \xf7			# meta-w, aproximadamente igual
	S_vbeam: \xb3			# meta-3, barra vertical
	S_hbeam: \xc4			# meta-D, barra horizontal
	S_sw_ml: \xb3			# meta-3, barra vertical
	S_sw_mr: \xb3			# meta-3, barra vertical
	S_expl_ml: \xb3			# meta-3, barra vertical
	S_expl_mr: \xb3			# meta-3, barra vertical
...
start: RogueIBM
	...
	S_book: \x2b
	S_wand: \xe7
	S_vwall: \xba			# todos los muros usan ahora
	S_hwall: \xcd			# graficos de linea doble
	S_tlcorn: \xc9
	S_trcorn: \xbb
	S_blcorn: \xc8
	S_brcorn: \xbc
	...
	S_vodoor: \xce
	S_hodoor: \xce
	S_room: \xfa			# punto centrado
	S_corr: \xb1
	S_litcorr: \xb2
	S_engrcorr: \xb1
	S_upstair: \xf0			# Xi griego
	S_dnstair: \xf0
	S_brupstair: \xf0		# Xi griego
	S_brdnstair: \xf0
finish

start: RogueEpyx
	Description: conjunto de simbolos de color para nivel rogue como Epyx Rogue
	Restrictions: rogue
	Handling: IBM
	Color: Yes
	S_vwall: \xba			# todos los muros usan ahora
	...
	S_brupstair: \xf0		# Xi griego
	S_brdnstair: \xf0
	S_arrow_trap: \x04		# diamante (naipes)
	S_dart_trap: \x04
	...
	S_weapon: \x18			# flecha arriba
# ^J	S_armor: \x0a			# Vert rect with o
	S_armor: \x5b			# por defecto: '['
# ^I	S_ring: \x09			# circle with arrow
	S_ring: \x3d			# por defecto: '='
	S_amulet: \x0c			# simbolo "femenino"
	S_tool: \x28			# por defecto: '('
	S_food: \x05			# trebol (como en naipes)
	S_potion: \xad			# '!' invertido
	S_scroll: \x0e			# nota musical
	S_book: \x2b			# por defecto: '+'
	S_wand: \xe7			# tau griego
	S_coin: \x0f			# si, es el mismo que gemas
	S_gem: \x0f			# '*' adornado
	S_rock: \x60
	S_ball: \x30
	S_chain: \x5f
...
start: curses
	Description: aproximacion de IBMgraphics usando DECgraphics
	Restrictions: primary
	Handling: DEC
	S_vwall: \xf8			# meta-x, barra vertical
	S_hwall: \xf1			# meta-q, barra horizontal
	S_tlcorn: \xec			# meta-l, esquina superior izquierda
	S_trcorn: \xeb			# meta-k, esquina superior derecha
	S_blcorn: \xed			# meta-m, esquina inferior izquierda
	S_brcorn: \xea			# meta-j, esquina inferior derecha
	S_crwall: \xee			# meta-n, cruz
	S_tuwall: \xf6			# meta-v, T hacia arriba
	S_tdwall: \xf7			# meta-w, T hacia abajo
	S_tlwall: \xf5			# meta-u, T hacia la izquierda
	S_trwall: \xf4			# meta-t, T hacia la derecha
	S_ndoor: \xfe			# meta-z, punto centrado
	S_bars: \xfc			# meta-|, signo no igual (era '#')
	S_tree: \xe7			# meta-g, signo mas o menos
	S_room: \xfe			# meta-z, punto centrado
	# S_engroom: \xee		# epsilon [\xee is actually cross wall]
	S_corr: \xe1			# meta-a, tablero de damas
	S_litcorr: \xe1			# meta-a, tablero de damas
	S_engrcorr: \xe1		# meta-a, tablero de damas
	S_ice: \xfe			# meta-z, punto centrado
	S_vodbridge: \xfe		# meta-z, punto centrado
	S_hodbridge: \xfe		# meta-z, punto centrado
	S_vbeam: \xf8			# meta-3, barra vertical
	S_hbeam: \xf1			# meta-D, barra horizontal
	S_sw_ml: \xf8			# meta-3, barra vertical
	S_sw_mr: \xf8			# meta-3, barra vertical
	S_expl_ml: \xf8			# meta-3, barra vertical
	S_expl_mr: \xf8			# meta-3, barra vertical
	G_vwall_sokoban:  /blue
	G_hwall_sokoban:  /blue
	G_tlcorn_sokoban: /blue
	G_trcorn_sokoban: /blue
...
start: DECgraphics
	...
	S_tlwall: \xf5			# meta-u, T hacia la izquierda
	S_trwall: \xf4			# meta-t, T hacia la derecha
	S_ndoor: \xfe			# meta-~, punto centrado
	S_vodoor: \xe1			# meta-a, tablero de damas
	S_hodoor: \xe1			# meta-a, tablero de damas
	S_bars: \xfc			# meta-|, not-equals (used to be pi)
	S_tree: \xe7			# meta-g, mas o menos
	S_room: \xfe			# meta-~, punto centrado
	S_upladder: \xf9		# meta-y, menor o igual
	S_dnladder: \xfa		# meta-z, mayor o igual
	S_brupladder: \xf9		# meta-y, menor o igual
	S_brdnladder: \xfa		# meta-z, mayor o igual
	S_altar: \xfb			# meta-{, pi (antes era '_')
	S_pool: \xe0			# meta-\, diamante
	S_ice: \xfe			# meta-~, punto centrado
	S_lava: \xe0			# meta-\, diamante
	S_lavawall: \xe0		# meta-\, diamante
	S_vodbridge: \xfe		# meta-~, punto centrado
	S_hodbridge: \xfe		# meta-~, punto centrado
	S_water: \xe0			# meta-\, diamante
	S_vbeam: \xf8			# meta-x, barra vertical
	S_hbeam: \xf1			# meta-q, barra horizontal
	S_sw_tc: \xef			# meta-o, linea horizontal alta
	S_sw_ml: \xf8			# meta-x, barra vertical
	S_sw_mr: \xf8			# meta-x, barra vertical
	S_sw_bc: \xf3			# meta-s, linea horizontal baja
	S_expl_tc: \xef			# meta-o, linea horizontal alta
	S_expl_ml: \xf8			# meta-x, barra vertical
	S_expl_mr: \xf8			# meta-x, barra vertical
	S_expl_bc: \xf3			# meta-s, linea horizontal baja
	G_vwall_sokoban:  /blue
	G_hwall_sokoban:  /blue
	G_tlcorn_sokoban: /blue
	G_trcorn_sokoban: /blue
...
#	Restrictions: primary
	...
	S_hcdoor: \xef
	S_bars: \xf0			# simbolo de equivalencia
	S_tree: \xf1			# mas o menos
	S_corr: \xb0
	S_engrcorr: \xb0
	S_grave: \xef			# igual que puerta abierta
	S_pool: \xe0
finish
...
# Unicode features.
start: Enhanced1
	Description: mejorado con glifos Unicode y color de 24 bits
	Restrictions: primary
	Handling: UTF8
...
#       This has double line wall symbols.
	Description: mejorado con mas glifos Unicode y color de 24 bits
	Restrictions: primary
	Handling: UTF8
	S_corr: U+2591
	S_litcorr: U+2592
...
start: AmigaFont
	Description: caracteres de dibujo de lineas y efectos de hack.font de Amiga
	# Dungeon features
	S_stone: \x20
	S_vwall: \xc0
	S_hwall: \xc1
